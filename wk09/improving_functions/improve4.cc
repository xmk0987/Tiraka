...
/**
 * @brief Sorts a given sequence using a 3 part randomized quicksort algorithm.
 *        Randomization is used to avoid worst case (where all values in the
 *        sequence are already in order).
 *
